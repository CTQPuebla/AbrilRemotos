...
public class DetalleController {
	...
	//http://localhost:8090/api/detalles/mostrar-todos/
	...
	//http://localhost:8090/api/detalles/buscar-por-id/?
	...
	//http://localhost:8090/api/detalles/guardar/
	@PostMapping("guardar")
	...
	//http://localhost:8090/api/detalles/actualizar/
