...
public class EmpleadoService {
	...
	//http://localhost:8085/jdbc-web/jdbc-web/empleados/mostrar GET
	@Path("mostrar")
	@GET
	...
	//http://localhost:8085/jdbc-web/jdbc-web/empleados/guardar POST
	@Path ("guardar")
	@POST
	...
	//Endpoint actualizar
	//http://localhost:8085/jdbc-web/jdbc-web/empleados/actualizar POST
	@Path ("actualizar")
	@POST
	@Consumes({MediaType.APPLICATION_JSON})
	@Produces({MediaType.APPLICATION_JSON})
	...
	//Metodo eliminar
	//http://localhost:8085/jdbc-web/jdbc-web/empleados/buscar-por-id/1
	@Path ("eliminar/{id}")
	@GET	
	@Produces({MediaType.APPLICATION_JSON})
	...
	//http://localhost:8085/jdbc-web/jdbc-web/empleados/buscar-por-id/2 GET
